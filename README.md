...
The **Museum With No Frontiers — Sculptures** gallery, built from the published
dataset `@museumwnf/sculptures-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/sculptures-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/sculptures/> through the reusable workflows in
