...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'sculptures',
  ...
  home: {
    title: 'sculptures.identity.title',
    intro: 'sculptures.home.intro',
    cards: [
      {
        title: 'sculptures.nav.catalogue',
        description: 'sculptures.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'sculptures.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'sculptures.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'sculptures.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'sculptures.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'sculptures.partnerObjects.emptyPartner',
  //         emptyInstitution: 'sculptures.partnerObjects.emptyInstitution',
  //         institutionSummary: 'sculptures.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'sculptures.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'sculptures.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
