...
// `useGalleryData.js` used to be byte-identical local copies of what sculptures
...
// legacy project key, no UUID — sculptures shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (sculptures-data 1.0.11+), an outside
